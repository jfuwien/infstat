...
\begin{remark}
	Bezeichnung: Für einen Test der oberen Form ist der \textbf{p-Wert}\index{p-Wert} des Signifikanzniveaus jenes Test, bei dem der kritische Wert $ c $ versetzt wird durch den beobachteten Wert der Test-Statistik. 
...
\begin{example}(Der z-Test)
	...
	\begin{aligned}
		...
		& = \Prob(|N(0,1)|\ge c) \\
		& = \Prob(N(0,1)\le -c)+1-\Prob(N(0,1)\ge c) \\
		& = \Phi(-c)+1-\Phi(c) \\
