...
\begin{definition}[Konsistenz]
	...
	\[
	\forall \epsilon > 0, \forall \theta \in \Theta : \Prob_\theta \left(||\hat{\theta}_n - \theta || > 0 \right) \overset{n\to\infty}{\longrightarrow} 0.
	\]
...
\begin{remark}
	...
	\begin{itemize}
		...
		\item $ \Prob(A_1 + \ldots + A_p >\epsilon)\le \sum_{k=1}^{p} \Prob\left(A_k >\frac{\epsilon}{p} \right) \; \ldots \; \text{Ubung.} $
	\end{itemize}
\end{remark}
